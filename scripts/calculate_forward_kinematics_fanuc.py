...
'''This script calculates the forward kinematics for the Fanuc M10iA robot '''
...
def calc_transform(q):
    T01 = sp.Matrix([[-sp.cos(q[0]), 0, -sp.sin(q[0]), 150 * sp.cos(q[0])],
                     [-sp.sin(q[0]), 0, sp.cos(q[0]), 150 * sp.sin(q[0])],
                     [0, 1, 0, 450],
                     [0, 0, 0, 1]])

    T12 = sp.Matrix([[-sp.sin(q[1]), -sp.cos(q[1]), 0, -600 * sp.sin(q[1])],
                     [sp.cos(q[1]), -sp.sin(q[1]), 0, 600 * sp.cos(q[1])],
                     [0, 0, 1, 0],
                     [0, 0, 0, 1]])

    T23 = sp.Matrix([[-sp.cos(q[2]), 0, -sp.sin(q[2]), 200 * sp.cos(q[2])],
                     [-sp.sin(q[2]), 0, sp.cos(q[2]), 200 * sp.sin(q[2])],
                     [0, 1, 0, 0],
                     [0, 0, 0, 1]])
...
if __name__ == "__main__":
    ...
    T01, T02, T03, T04, T05, T = calc_transform(q)
    ...
    home = [0, 0, 0, 0, 0, 0]
    T_ = T.subs([(q[0], home[0]), (q[1], home[1]), (q[2], home[2]), (q[3], home[3]), (q[4], home[4]), (q[5], home[5])])
    x_ = Tx.subs([(q[0], home[0]), (q[1], home[1]), (q[2], home[2]), (q[3], home[3]), (q[4], home[4]), (q[5], home[5])])
