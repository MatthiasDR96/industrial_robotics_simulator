...
from industrial_robotics_simulator.controllers.joint_space_feedforward_controller import *

""" This script uses feedforward motion control to move to a target."""
